...
public class GameLogic {
    ...
    private String inputChoise() {
        String result;
        do {
            result = scanner.nextLine();
            if (result.length() == 1 && (result.equals("N") || result.equals("n") || result.equals("e") || result.equals("E"))) {
                return result;
            } else {
